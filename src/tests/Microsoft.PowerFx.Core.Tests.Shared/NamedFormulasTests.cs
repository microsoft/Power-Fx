...
namespace Microsoft.PowerFx.Core.Tests
{
    public class NamedFormulasTests : PowerFxTest
    {
        ...
        public void NamedFormulaAndUdfTest_ColonEqualRequired(string script, int namedFormulaCount, int udfCount, bool expectErrors)
        {
            var parserOptions = new ParserOptions()
            {
                AllowsSideEffects = false,
        ...
        public void TestCulture(string expressionDot)
        {
            ...
            var checkResultDot = new DefinitionsCheckResult()
                               ...
                               .SetBindingInfo(ReadOnlySymbolTable.NewDefault(BuiltinFunctionsCore._library));
