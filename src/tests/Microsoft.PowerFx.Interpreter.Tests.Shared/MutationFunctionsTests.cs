...
namespace Microsoft.PowerFx.Interpreter.Tests
{
    public class MutationFunctionsTests : PowerFxTest
    {
        ...
        // Deep mutations are not supported on the iterated record                                      delegable DS,   non-del DS,  variable DS

        [InlineData("ForAll(DS, Set(Id, 3))                                                          ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("ForAll(DS, Set(ThisRecord.Id, 3))                                               ", " Immutable", " Immutable", " Immutable")]
        [InlineData("ForAll(DS As A, Set(A.Id, 3))                                                   ", " Immutable", " Immutable", " Immutable")]
        [InlineData("AddColumns(DS, Num, Set(Id, 3); 2)                                              ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("AddColumns(DS, Num, Set(ThisRecord.Id, 3); 2)                                   ", " Immutable", " Immutable", " Immutable")]
        [InlineData("AddColumns(DS As A, Num, Set(A.Id, 3); 2)                                       ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Concat(DS, Set(Id, 3); Text(Id))                                                ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Concat(DS, Set(ThisRecord.Id, 3); Text(Id))                                     ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Concat(DS As A, Set(A.Id, 3); Text(Id))                                         ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Distinct(DS, Set(Id,3); Id)                                                     ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Distinct(DS, Set(ThisRecord.Id,3); Id)                                          ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Distinct(DS As A, Set(A.Id,3); Id)                                              ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Sum(DS, Set(Id, 3); Id)                                                         ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Sum(DS, Set(ThisRecord.Id, 3); Id)                                              ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Sum(DS As A, Set(A.Id, 3); Id)                                                  ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Average(DS, Set(Id, 3); Id)                                                     ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Average(DS, Set(ThisRecord.Id, 3); Id)                                          ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Average(DS As A, Set(A.Id, 3); Id)                                              ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Min(DS, Set(Id, 3); Id)                                                         ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Min(DS, Set(ThisRecord.Id, 3); Id)                                              ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Min(DS As A, Set(A.Id, 3); Id)                                                  ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Max(DS, Set(Id, 3); Id)                                                         ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("Max(DS, Set(ThisRecord.Id, 3); Id)                                              ", " Immutable", " Immutable", " Immutable")]
        [InlineData("Max(DS As A, Set(A.Id, 3); Id)                                                  ", " Immutable", " Immutable", " Immutable")]
        [InlineData("VarP(DS, Set(Id, 3); Id)                                                        ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("VarP(DS, Set(ThisRecord.Id, 3); Id)                                             ", " Immutable", " Immutable", " Immutable")]
        [InlineData("VarP(DS As A, Set(A.Id, 3); Id)                                                 ", " Immutable", " Immutable", " Immutable")]
        [InlineData("StdevP(DS, Set(Id, 3); Id)                                                      ", "   CantMod", "   CantMod", "   CantMod")]
        [InlineData("StdevP(DS, Set(ThisRecord.Id, 3); Id)                                           ", " Immutable", " Immutable", " Immutable")]
        [InlineData("StdevP(DS As A, Set(A.Id, 3); Id)                                               ", " Immutable", " Immutable", " Immutable")]
        ...
        [InlineData("Average(DS, Set(DS, [{Id:1,Name:\"a\"}]); Id)                                   ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Min(DS, Set(DS, [{Id:1,Name:\"a\"}]); Id)                                       ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Max(DS, Set(DS, [{Id:1,Name:\"a\"}]); Id)                                       ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("VarP(DS, Set(DS, [{Id:1,Name:\"a\"}]); Id)                                      ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("StdevP(DS, Set(DS, [{Id:1,Name:\"a\"}]); Id)                                    ", "   SelfMod", "   SelfMod", "   SelfMod")]
        ...
        [InlineData("ForAll(DS, Remove(DS, {}))                                                      ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("AddColumns(DS, Num, Remove(DS, {}); 2)                                          ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Concat(DS, Remove(DS, {}); Text(Id))                                            ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Distinct(DS, Remove(DS, {}); Id)                                                ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Sum(DS, Remove(DS, {}); Id)                                                     ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Average(DS, Remove(DS, {}); Id)                                                 ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Min(DS, Remove(DS, {}); Id)                                                     ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("Max(DS, Remove(DS, {}); Id)                                                     ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("VarP(DS, Remove(DS, {}); Id)                                                    ", "   SelfMod", "   SelfMod", "   SelfMod")]
        [InlineData("StdevP(DS, Remove(DS, {}); Id)                                                  ", "   SelfMod", "   SelfMod", "   SelfMod")]
