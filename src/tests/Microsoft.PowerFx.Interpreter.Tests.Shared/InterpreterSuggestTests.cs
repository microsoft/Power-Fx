...
namespace Microsoft.PowerFx.Interpreter.Tests
{
    public class InterpreterSuggestTests : IntellisenseTestBase
    {
        ...
        public void TestSuggestVariableName(string suggestion)
        {
            ...
            Assert.NotNull(s1);
            Assert.Equal(9, s1.Count()); // 8 original + Infinity (added in #3010)
        ...
        [Theory]
        [InlineData("Collect(Table({aa:1, ab:1}, {aa:3, ab:4}), {|", "aa:, ab:")]
        [InlineData("Collect(Table({aa:1, ab:2}, {aa:3, ab:4, ac:5, ba:7}), {|", "aa:, ab:, ac:, ba:")]
        [InlineData("Collect(Table({aa:1, ab:3}, {aa:3, ab:4, ac:5, ba:7}), { a|", "aa:, ab:, ac:, ba:")]
        [InlineData("Collect(Table({aa:1, ab:4}, {aa:3, ab:4, ac:5, ba:7}), { ac:8, aa: |", @"")]
        [InlineData("Collect(Table({aa:1, ab:5}, {aa:3, ab:4, ac:5}), { ac , aa: |", @"")]        
        [InlineData("Collect(Table({aa:1, ab:6}, {aa:3, ab:4, ac:5, ba:7}), { b|", "ab:, ba:")]
        [InlineData("Collect(Table({aa:1, ab:7}, {aa:3, ab:4, ac:5, ba:7}), { c|", @"ac:")]
        [InlineData("Collect(Table({aa:1, ab:8}, {aa:3, ab:4, ac:5, ba:7}), { aa:5, a|", @"ab:, ac:, ba:")]
        [InlineData("Collect(Table({aa:1, ab:9}, {aa:3, ab:4, ac:5, ba:7}), { aa:5, ab:6, ac:7, a|", @"ba:")]
        [InlineData("Collect(Table({aa:1, ab:10}, {aa:3, ab:4, ac:5, ba:7}), { aa:5, ab:6, ac:7, |", @"ba:")]
        [InlineData("Collect(Table({aa:1, ab:11}, {aa:3, ab:4, ac:5, ba:7}), { aa:5, c|", @"ac:")]
        [InlineData("Collect(Table({aa:1, ab:12}, {aa:3, ab:4, ac:5, ba:7}), { aa:5, c:7, b|", @"ab:, ba:")]
