...
namespace Microsoft.PowerFx.Tests
{
    ...
    {
        private static readonly Features PFxV1Enabled = new Features() { PowerFxV1CompatibilityRules = true };
        ...
        {
            // Coercion to string
            Assert.True(DType.Guid.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Boolean.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Currency.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Hyperlink.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Image.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.PenImage.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Media.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Blob.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out DType type) && type.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to GUID
            Assert.False(DType.Boolean.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(usePowerFxV1CompatibilityRules, DType.String.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Guid.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%g[A:\"hello\"]", out type) && type.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Guid, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to number
            Assert.True(DType.Boolean.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Currency.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Number, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to boolean
            Assert.True(DType.Boolean.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Currency.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to currency
            Assert.True(DType.Boolean.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Currency.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%$[A:2]", out type) && type.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Currency, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to Decimal
            Assert.True(DType.Boolean.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%w[A:2]", out type) && type.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Decimal, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to color
            Assert.False(DType.Boolean.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Color.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%c[A:2]", out type) && type.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Color, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to dateTime
            Assert.False(DType.Boolean.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(!usePowerFxV1CompatibilityRules, DType.Currency.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%d[A:2]", out type) && type.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.DateTime, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to image
            Assert.False(DType.Boolean.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Hyperlink.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Image.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.PenImage.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Blob.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%i[A:\"hello.jpg\"]", out type) && type.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Image, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to penimage
            Assert.False(DType.Boolean.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.PenImage.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.PenImage, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to media
            Assert.False(DType.Boolean.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Hyperlink.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Media.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Blob.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%m[A:\"hello\"]", out type) && type.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Media, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to document
            Assert.False(DType.Boolean.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Hyperlink.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Image.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.PenImage.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Media.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Blob.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%o[A:\"hello\"]", out type) && type.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Blob, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to hyperlink
            Assert.False(DType.Boolean.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Hyperlink.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Image.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.PenImage.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Media.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Blob.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%h[A:\"hello\"]", out type) && type.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Hyperlink, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to table
            Assert.False(DType.Boolean.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyTable.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyRecord.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:n]", out type) && type.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:n]", out DType type1) && DType.TryParse("*[A:n]", out DType type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:n, B:s]", out type1) && DType.TryParse("*[A:n]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:*[B:s]]", out type1) && DType.TryParse("*[A:*[B:s]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:*[B:![C:n]]]", out type1) && DType.TryParse("*[A:*[B:![C:n]]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:*[B:s]]", out type1) && DType.TryParse("*[A:*[B:n]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:*[B:![C:n]]]", out type1) && DType.TryParse("*[A:*[B:*[C:n]]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("![A:![B:s]]", out type1) && DType.TryParse("*[A:*[B:s]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            Assert.False(DType.TryParse("![A:*[B:s]]", out type1) && DType.TryParse("*[A:n]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(usePowerFxV1CompatibilityRules, DType.TryParse("![A:n]", out type1) && DType.TryParse("*[A:n, B:s]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("![A:*[B:*[C:n]]]", out type1) && DType.TryParse("*[A:*[B:![C:n]]]", out type2) && type1.CoercesTo(type2, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            Assert.False(DType.EmptyEnum.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.EmptyTable, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to record
            Assert.False(DType.Boolean.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyRecord.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyEnum.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.EmptyRecord, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to Date
            Assert.False(DType.Boolean.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(!usePowerFxV1CompatibilityRules, DType.Currency.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%D[A:2]", out type) && type.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Date, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to Time
            Assert.False(DType.Boolean.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Number.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(!usePowerFxV1CompatibilityRules, DType.Currency.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Decimal.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.DateTime.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Date.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Time.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.String.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyRecord.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.EmptyEnum.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.TryParse("%T[A:2]", out type) && type.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%n[A:2]", out type) && type.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%b[A:true]", out type) && type.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(DType.Time, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to Attachment Table type
            Assert.False(DType.Boolean.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(usePowerFxV1CompatibilityRules, DType.EmptyTable.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(usePowerFxV1CompatibilityRules, DType.EmptyRecord.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(AttachmentTableType.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyEnum.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(AttachmentTableType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));

            // Coercion to Attachment Record type
            Assert.False(DType.Boolean.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Number.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Currency.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Decimal.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Color.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Guid.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.DateTime.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Date.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Time.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.String.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Hyperlink.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Image.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.PenImage.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Media.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Blob.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyTable.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.Equal(usePowerFxV1CompatibilityRules, DType.EmptyRecord.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(AttachmentRecordType.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.EmptyEnum.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.TryParse("%s[A:\"hello\"]", out type) && type.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.ObjNull.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Error.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.True(DType.Deferred.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
            Assert.False(DType.Void.CoercesTo(AttachmentRecordType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
        ...
        public void DTypeTestOptionSetCoercion()
        {
            foreach (var usePFxV1CompatRules in new[] { false, true })
            {
                ...
                Assert.True(OptionSetType.CoercesTo(OptionSetType, aggregateCoercion: true, isTopLevelCoercion: false, features: usePFxV1CompatRules ? PFxV1Enabled : Features.None));

                Assert.False(OptionSetValueType.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePFxV1CompatRules ? PFxV1Enabled : Features.None));
                Assert.True(OptionSetValueType.CoercesTo(DType.String, aggregateCoercion: true, isTopLevelCoercion: false, features: usePFxV1CompatRules ? PFxV1Enabled : Features.None));

                Assert.True(BooleanValuedOptionSetValueType.CoercesTo(DType.Boolean, aggregateCoercion: true, isTopLevelCoercion: false, features: usePFxV1CompatRules ? PFxV1Enabled : Features.None));
            }
        }
        ...
        private void TestUnion(string t1, string t2, string tResult, bool usePowerFxV1CompatibilityRules)
        {
            ...
            Assert.Equal<DType>(typeResult, DType.Union(type1, type2, useLegacyDateTimeAccepts: false, features: usePowerFxV1CompatibilityRules ? PFxV1Enabled : Features.None));
        }
