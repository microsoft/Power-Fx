...
namespace Microsoft.PowerFx.Core.Tests
{
    public class TestResourceManager : IResourceManager
    {
        ...
        public int NewElementFromString(string str, FileType fileType = FileType.Any)
        {
            return AddResource(new TestResourceElement(fileType, str, false));
        }

        public int NewElementFromBase64String(string base64str, FileType fileType = FileType.Any)
        {
            return AddResource(new TestResourceElement(fileType, base64str, true));
        }
