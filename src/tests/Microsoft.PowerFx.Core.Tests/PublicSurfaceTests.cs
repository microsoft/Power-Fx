    ...
    public class PublicSurfaceTests
    {
        ...
        public void Test()
        {
            ...
            var allowed = new HashSet<string>()
            {
                ...
                "Microsoft.PowerFx.Core.PrimitiveMarshallerProvider",
                "Microsoft.PowerFx.Core.PrimitiveTypeMarshaler",
                "Microsoft.PowerFx.Core.TableMarshallerProvider",
                "Microsoft.PowerFx.Core.TypeMarshallerCache",
                "Microsoft.PowerFx.Core.ObjectRecordValue",
