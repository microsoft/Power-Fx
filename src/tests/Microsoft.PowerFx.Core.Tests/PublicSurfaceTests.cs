    ...
    public class PublicSurfaceTests
    {
        ...
        public void PublicSurface_Tests()
        {
            ...
            var allowed = new HashSet<string>()
            {
                ...
                "Microsoft.PowerFx.Core.Functions.DefaultResourceManager",
                "Microsoft.PowerFx.Core.Functions.DefaultResourceElement",
                "Microsoft.PowerFx.Core.Functions.IResourceManager",
                "Microsoft.PowerFx.Core.Functions.IResourceElement",
                "Microsoft.PowerFx.Core.Functions.ResourceHandle",
