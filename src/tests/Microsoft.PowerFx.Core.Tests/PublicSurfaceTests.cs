    ...
    public class PublicSurfaceTests
    {
        ...
        public void PublicSurface_Tests()
        {
            ...
            var allowed = new HashSet<string>()
            {
                ...
                "Microsoft.PowerFx.Core.Functions.BlobElementBase",
                "Microsoft.PowerFx.Core.Functions.Base64Blob",
                "Microsoft.PowerFx.Core.Functions.StringBlob",
                "Microsoft.PowerFx.Core.Functions.UriBlob",
                "Microsoft.PowerFx.Core.Functions.ByteArrayBlob",
                "Microsoft.PowerFx.Core.Functions.StreamBlob",
