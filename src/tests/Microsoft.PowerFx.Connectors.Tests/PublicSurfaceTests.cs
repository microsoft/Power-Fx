    ...
    public class PublicSurfaceTests
    {
        ...
        public void PublicSurfaceTest_Connectors()
        {
            ...
            var allowed = new HashSet<string>()
            {
              ...
              "Microsoft.PowerFx.Connectors.Execution.IConnectorInvoker",
              "Microsoft.PowerFx.Connectors.Execution.IConnectorSender`3",
              "Microsoft.PowerFx.Connectors.Execution.FunctionInvoker`3",
