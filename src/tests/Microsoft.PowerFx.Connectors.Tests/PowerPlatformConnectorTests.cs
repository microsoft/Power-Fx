...
";
        ...
        public async Task SQL_ExecuteStoredProc()
        {
            ...
            Assert.Equal(3, (result as UntypedObjectValue).Impl.GetProperties().Count());
...
";
        ...
        public async Task Dataverse()
        {
            ...
            using var client = new PowerPlatformConnectorClient(
                ...
                "Default-9f6be790-4a16-4dd6-9850-44a0d2649aef",          // environment
                "shared-commondataser-1c7801e8-2d60-41b2-a17a-f808bcb60c93",              // connectionId
                () => "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyIsImtpZCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyJ9..b3DNArI1UBI9CnOOjtPInOd-kUfiQcdkDVnEPHTza_Rpyg5HQGKa3rH1PBxrfUpO4xrS6iP2BFDX5Irgvrc27ANkA2Zx6d5k0Gz0-qvVXaFHnQTgYizzLhYijn0h2IwIgt_JeBD6DXFqDgiDOpyOZRiIquPTnFeLQ6xoGwUzzhIcuuCyR2gEEfpBRJxS-jgebcWRfE9UdxIrjP_CzfTQkii-9E38EbrOXjZf1Zd8zOlICqSopYXtwGlHiEMaUIv34ACX4f3gtJ3rdkujKXohHJwB7_u3GTrGyB23eudVv3RFkiub46rczEIG6-HX25SlU58Mk6FupTC6igzExKVQMw",
                httpCLient)
            {
                SessionId = "02199f4f-8306-4996-b1c3-1b6094c2b7f8"
            };

            var functions = OpenApiParser.GetFunctions(Helpers.ReadSwagger(@"Swagger\DataverseLegacy.json"), client);

            var function = functions.Single(x => x.Name == "GetItemV2");

            try
            {
                var result = await function.InvokeAync(client, new FormulaValue[] { FormulaValue.New("https%3a%2f%2forg283e9949.crm10.dynamics.com"), FormulaValue.New("contacts"), FormulaValue.New("a50456c8-d431-ee11-bdf4-0022482c6a88") }, default).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
        ...
        [Fact]
        public async Task Dataverse_Modern()
        {
            using var httpCLient = new HttpClient();
            using var client = new PowerPlatformConnectorClient(
                "tip1-shared.azure-apim.net",               // endpoint
                "Default-9f6be790-4a16-4dd6-9850-44a0d2649aef",          // environment
                "shared-commondataser-a73f13de-6ff3-4f35-8e86-9f13435fcdf9",              // connectionId
                () => "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyIsImtpZCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyJ9..IZH24m0ZHEpx5lVTVbiYtcQIPRZmq4vUgJCN_C5tCPhFwcq_9Nhf_vmYkeNn3HVItVoYZB6fTaHR1BqZb0xO3hmjljJj09LTSB4QCdiru_XrK4kTmLYiOPXBsFJhtBHMV8VqT_4uB2nOllza2gSsOywCJ4KodV2X6pAx3Kub2nwsHRNoI7pIl-qgVPYEtxgk04obMbpWvbOLvZcyhKIXPWsm713R75V0jL9FFgRzbHSRU_A3knuKuZIIirlk5rM5jSWlK82EdEMK8Rnb-mhVhChhV0d3tIp1SjXIgONCXle9LOSKHi_9aRRln5dhmV8BI0bgN0v7tvK2b4z3Cch3cQ",
                httpCLient)
            {
                SessionId = "02199f4f-8306-4996-b1c3-1b6094c2b7f8"
            };

            var functions = OpenApiParser.GetFunctions(Helpers.ReadSwagger(@"Swagger\Dataverse.json"), client);

            var function = functions.Single(x => x.Name == "GetItem");

            try
            {
                var result = await function.InvokeAync(client, new FormulaValue[] { FormulaValue.New("contacts"), FormulaValue.New("a50456c8-d431-ee11-bdf4-0022482c6a88") }, default).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.ToString());
