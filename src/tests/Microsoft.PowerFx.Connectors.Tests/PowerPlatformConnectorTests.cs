...
namespace Microsoft.PowerFx.Tests
{
    ...
    public class PowerPlatformConnectorTests : PowerFxTest
    {
        ...
        public async Task MSNWeatherConnector_CurrentWeather(bool useSwaggerParameter)
        {
            ...
            RuntimeConfig runtimeConfig = new RuntimeConfig().AddRuntimeContext(new TestConnectorRuntimeContext("MSNWeather", client));
...
";
        ...
        public async Task Connector_GenerateErrors(int statusCode)
        {
            ...
            // Now execute it...
            var engine = new RecalcEngine(config);
            RuntimeConfig runtimeConfig = new RuntimeConfig().AddRuntimeContext(new TestConnectorRuntimeContext("TestConnector12", client));
...
";
        ...
        public void IntellisenseHelpStrings(string expr, bool withAllowSideEffects, bool expectedBehaviorError)
        {
            ...
            var config = new PowerFxConfig();
            config.AddActionConnector("MSNWeather", apiDoc);
...
";
        ...
        public async Task SQL_Tabular()
        {
            ...
            using var client = new PowerPlatformConnectorClient(
                    ...
                    () => "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyIsImtpZCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyJ9..mPaRx9TBP1l_x1JOpuS_7IQVEAzNAOfJ8_yM-MIA3VyFvldx_g_4zRm8kXMECZxJJec-IUqL13AuOuMZzhBg6eeHfT8U9-vD_wHIwiYkQYuY0pGuxJtb3OL7-fbAHC7EXQw7OtL0EI6aJIxw1kAjnu4i-l9BLyFltYIKoCMyY951r6cnHwEJULH_3RbKbiu4uQ9B4RA7z_QNGK9ejc6z1axgu8B0vc8dEYwFzgjlxrf_UjppkTQvXGRMQUYKDhrkXfb758kpDwgytC8hprqKBgZOS7H12hvc2YOTE1FWFFopFzdO4h78j44VkipbuffU6SivTiYB7yfm44WWW_xO8w",
                    httpClient)
            {
                SessionId = "8e67ebdc-d402-455a-b33a-304820832383"
            };
