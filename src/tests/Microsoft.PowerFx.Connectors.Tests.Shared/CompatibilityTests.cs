...
namespace Microsoft.PowerFx.Tests
{
    public class CompatibilityTests : PowerFxTest
    {
        ...
        public void CompatibilityTest()
        {
            ...
            ConnectorType ctCdp = ConnectorFunction.GetCdpTableType(tableResolver, "name", null, "schema/items", StringValue.New(text), new ConnectorSettings(null) { Compatibility = ConnectorCompatibility.CdpCompatibility }, "dataset", out _, out _, out _, out _);
            ConnectorType ctPa = ConnectorFunction.GetCdpTableType(tableResolver, "name", null, "schema/items", StringValue.New(text), new ConnectorSettings(null) { Compatibility = ConnectorCompatibility.PowerAppsCompatibility }, "dataset", out _, out _, out _, out _);
            ConnectorType ctSw = ConnectorFunction.GetCdpTableType(tableResolver, "name", null, "schema/items", StringValue.New(text), new ConnectorSettings(null) { Compatibility = ConnectorCompatibility.SwaggerCompatibility }, "dataset", out _, out _, out _, out _);
