    ...
    public class O365OutlookTests : BaseConnectorTest
    {
        ...
        */
        ...
        [InlineData(
            ...
            "ERR:Office365Outlook.GetEventsCalendarView failed: The server returned an HTTP error with code 400 (Bad Request).",
        ...
        [InlineData(
            ...
            "ERR:Office365Outlook.CalendarDeleteItem failed: The server returned an HTTP error with code 404 (Not Found).",
        ...
        */
        ...
        {
            await RunConnectorTestAsync(false, expr, expectedResult, xUrls, xBodies, expectedFiles.Split('|').ToArray(), true, extra);
        }
