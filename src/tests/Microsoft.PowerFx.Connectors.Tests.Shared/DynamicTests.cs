...
#pragma warning restore SYSLIB0014 // WebClient is obsolete
        ...
        public async Task DynamicValues_GetWithDynamicValuesStatic_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStatic.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStatic.RequiredParameters[0], connectorContext, CancellationToken.None);
        ...
        public async Task DynamicValues_GetWithDynamicValuesStatic_OptionalParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStaticOptional.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStaticOptional.OptionalParameters[0], connectorContext, CancellationToken.None);
            Assert.Equal("14|24", string.Join("|", cParameters.ParametersWithSuggestions[0].Suggestions.Select(s => s.DisplayName)));
        }
        ...
        public async Task DynamicValues_GetWithDynamicValuesStaticNoValueCollection_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStaticNoValueCollection.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStaticNoValueCollection.RequiredParameters[0], connectorContext, CancellationToken.None);
            Assert.Equal("14|24", string.Join("|", cParameters.ParametersWithSuggestions[0].Suggestions.Select(s => s.DisplayName)));
        }
        ...
        public async Task DynamicValues_GetWithDynamicValuesStaticInvalidValueCollection_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStaticInvalidValueCollection.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStaticInvalidValueCollection.RequiredParameters[0], connectorContext, CancellationToken.None);
        ...
        public async Task DynamicValues_GetWithDynamicValuesStaticInvalidDisplayName_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStaticInvalidDisplayName.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStaticInvalidDisplayName.RequiredParameters[0], connectorContext, CancellationToken.None);
            Assert.Equal(string.Empty, string.Join("|", cParameters.ParametersWithSuggestions[0].Suggestions.Select(s => s.DisplayName)));
        }
        ...
        public async Task DynamicValues_GetWithDynamicValuesStaticInvalidValuePath_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesStaticInvalidValuePath.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesStaticInvalidValuePath.RequiredParameters[0], connectorContext, CancellationToken.None);
            Assert.Equal(string.Empty, string.Join("|", cParameters.ParametersWithSuggestions[0].Suggestions.Select(s => s.DisplayName)));
        }
        ...
        public async Task DynamicValues_GetWithDynamicValuesDynamic_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesDynamic.GetParameterSuggestionsAsync(new NamedValue[] { new NamedValue("i", FormulaValue.New(5)) }, getWithDynamicValuesDynamic.RequiredParameters[1], connectorContext, CancellationToken.None);
        ...
        public async Task DynamicValues_GetWithDynamicValuesMultipleDynamic_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicValuesMultipleDynamic.GetParameterSuggestionsAsync(new NamedValue[] { new NamedValue("i", FormulaValue.New(5)), new NamedValue("j", FormulaValue.New(7)) }, getWithDynamicValuesMultipleDynamic.RequiredParameters[2], connectorContext, CancellationToken.None);
            Assert.Equal("50|60", string.Join("|", cParameters.ParametersWithSuggestions[2].Suggestions.Select(s => s.DisplayName)));

            // Missing parameter
            cParameters = await getWithDynamicValuesMultipleDynamic.GetParameterSuggestionsAsync(new NamedValue[] { new NamedValue("i", FormulaValue.New(5)) }, getWithDynamicValuesMultipleDynamic.RequiredParameters[2], connectorContext, CancellationToken.None);
            Assert.Equal(string.Empty, string.Join("|", cParameters.ParametersWithSuggestions[2].Suggestions.Select(s => s.DisplayName)));

            cParameters = await getWithDynamicValuesMultipleDynamic.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicValuesMultipleDynamic.OptionalParameters[0], connectorContext, CancellationToken.None);
            ...
            ConnectorType cType = await getWithDynamicValuesMultipleDynamic.GetConnectorParameterTypeAsync(Array.Empty<NamedValue>(), getWithDynamicValuesMultipleDynamic.OptionalParameters[0], connectorContext, CancellationToken.None);
            ...
            ConnectorType innerType = await getWithDynamicValuesMultipleDynamic.GetConnectorTypeAsync(Array.Empty<NamedValue>(), cType.Fields.First(field => field.Name == "Database"), connectorContext, CancellationToken.None);
            Assert.Equal("![Index:w, Name:s, PrimaryKey:s]", innerType.FormulaType.ToStringWithDisplayNames());

            ConnectorEnhancedSuggestions ces = await getWithDynamicValuesMultipleDynamic.GetConnectorSuggestionsAsync(Array.Empty<NamedValue>(), innerType.Fields.First(field => field.Name == "Index"), connectorContext, CancellationToken.None);
        ...
        public async Task DynamicValues_GetWithDynamicListStatic_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicListStatic.GetParameterSuggestionsAsync(Array.Empty<NamedValue>(), getWithDynamicListStatic.RequiredParameters[0], connectorContext, CancellationToken.None);
        ...
        public async Task DynamicValues_GetWithDynamicListDynamic_RequiredParameters()
        {
            ...
            ConnectorParameters cParameters = await getWithDynamicListDynamic.GetParameterSuggestionsAsync(new NamedValue[] { new NamedValue("i", FormulaValue.New(6)) }, getWithDynamicListDynamic.RequiredParameters[1], connectorContext, CancellationToken.None);
