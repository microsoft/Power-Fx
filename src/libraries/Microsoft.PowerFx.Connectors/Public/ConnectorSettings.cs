...
namespace Microsoft.PowerFx.Connectors
{
    ...
    public class ConnectorSettings
    {
        ...
        /// <summary>
        /// Use parameters/param/name instead of parameters/param/schema/properties/name when
        /// there is only one property for the body parameter.
        /// In PowerApps, body objects are flattened by default and we create one parameter per property
        /// of that object. Each of these parameters is names with the name of the property of that object.
        /// When there is only one property, this setting will force the use of the original body parameter.
        /// </summary>
        public bool UseRealBodyNameForSinglePropertyObject { get; init; } = false;
