...
namespace Microsoft.PowerFx
{
    ...
    public abstract class ReflectionFunction
    {
        ...
        internal TexlFunction GetTexlFunction()
        {
            ...
            return new CustomTexlFunction(info.Name, info.RetType, (runtimeConfig, args, cancellationToken) => InvokeAsync(runtimeConfig, args, cancellationToken), info.LamdaParamMask, info.ParamTypes);
        }
