...
namespace Microsoft.PowerFx
{
    public static class PowerFxConfigExtensions
    {
        ...
        /// <summary>
        /// Enable all multation functions which allows scripts to execute side effect behavior.
        /// For new Power Fx hosts, use EnableMutationFunctionsIterationSafe instead which prevents Set from being 
        /// used in a non-deterministic iteration context such as Sort.
        /// </summary>
        /// <param name="symbolTable"></param>
        ...
        /// </summary>
        /// <param name="symbolTable"></param>
        public static void EnableMutationFunctionsCore(this SymbolTable symbolTable)
        {
            symbolTable.AddFunction(new RecalcEngineSetFunction());
