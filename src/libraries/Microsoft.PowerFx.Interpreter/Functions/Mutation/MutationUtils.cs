...
namespace Microsoft.PowerFx.Interpreter
{
    internal class MutationUtils
    {
        ...
        public static async Task<FormulaValue> RemoveCore(FormulaValue[] args, CancellationToken cancellationToken)
        {
            ...
            if (response.IsError)
            {
                ...
                return new ErrorValue(IRContext.NotInSource(FormulaType.Void), errors);
            }
