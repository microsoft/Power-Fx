    ...
    internal static partial class Library
    {
            ...
            where T : FormulaValue
        {
            return async (runner, context, irContext, args) =>
            {
                ...
                var anyValueBlank = runtimeValuesChecked.Any(arg => arg is BlankValue || (arg is UntypedObjectValue uov && (uov.Impl is UntypedObjectBase uob ? uob.IsBlank() : uov.Impl.Type == FormulaType.Blank)));
