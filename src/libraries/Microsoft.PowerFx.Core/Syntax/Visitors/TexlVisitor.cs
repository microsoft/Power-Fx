...
namespace Microsoft.PowerFx.Core.Syntax.Visitors
{
    ...
    internal abstract class TexlVisitor
    {
        ...
        public virtual bool PreVisit(DottedNameNode node) { return true; }
        public virtual bool PreVisit(UnaryOpNode node) { return true; }
        public virtual bool PreVisit(BinaryOpNode node) { return true; }
        public virtual bool PreVisit(VariadicOpNode node) { return true; }
        public virtual bool PreVisit(CallNode node) { return true; }
        public virtual bool PreVisit(ListNode node) { return true; }
        public virtual bool PreVisit(RecordNode node) { return true; }
        public virtual bool PreVisit(TableNode node) { return true; }
        public virtual bool PreVisit(AsNode node) { return true; }
