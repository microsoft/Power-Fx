...
namespace Microsoft.PowerFx.Syntax
{
    ...
    public sealed class CallNode : TexlNode
    {
        ...
        public override Span GetTextSpan()
        {
            ...
            return new Span(Head.Token.Span.Min, ParenClose.Span.Lim, Head.Token.Span.BaseIndex);
        }
        ...
        public override Span GetCompleteSpan()
        {
            ...
            if (HeadNode != null && (dotted = HeadNode.AsDottedName()) != null)
            {
                return new Span(dotted.GetCompleteSpan().Min, limit, dotted.GetCompleteSpan().BaseIndex);
            }

            return new Span(Head.Token.Span.Min, limit, Head.Token.Span.BaseIndex);
        }
