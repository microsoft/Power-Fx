...
namespace Microsoft.PowerFx.Core.Localization
{
    internal static class TexlStrings
    {
        ...
        public static StringGetter AboutIndexT = (b) => StringResources.Get("AboutIndexT", b);
        public static StringGetter IndexTArg1 = (b) => StringResources.Get("IndexTArg1", b);
        public static StringGetter IndexTArg2 = (b) => StringResources.Get("IndexTArg2", b);
