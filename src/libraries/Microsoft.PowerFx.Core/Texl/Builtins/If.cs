...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class IfFunction : BuiltinFunction
    {
        ...
        public IfFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "If", TexlStrings.AboutIf, FunctionCategories.Logical, DType.Unknown, 0, 2, int.MaxValue)
        {
