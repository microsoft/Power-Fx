...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class AsTypeFunction : BuiltinFunction
    {
        ...
        protected override bool CheckInvocation(TexlBinding binding, TexlNode[] args, DType[] argTypes, IErrorContainer errors, out DType returnType, out Dictionary<TexlNode, DType> nodeToCoercedTypeMap)
        {
