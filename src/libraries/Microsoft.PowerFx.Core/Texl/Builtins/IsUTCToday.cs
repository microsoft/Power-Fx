...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class IsUTCTodayFunction : BuiltinFunction
    {
        ...
        public IsUTCTodayFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "IsUTCToday", TexlStrings.AboutIsUTCToday, FunctionCategories.Information, DType.Boolean, 0, 1, 1, DType.DateTime)
        {
        }
