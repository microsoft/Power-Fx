...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class DropColumnsFunction : FunctionWithTableInput
    {
        ...
        public DropColumnsFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "DropColumns", TexlStrings.AboutDropColumns, FunctionCategories.Table, DType.EmptyTable, 0, 2, int.MaxValue, DType.EmptyTable)
        {
        }
