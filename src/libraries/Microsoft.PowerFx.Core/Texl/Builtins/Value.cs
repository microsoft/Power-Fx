...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class ValueFunction : BuiltinFunction
    {
        ...
        public ValueFunction()
            : base(ValueInvariantFunctionName, TexlStrings.AboutValue, FunctionCategories.Text, DType.Number, 0, 0, 1, 2, DType.String, DType.String)
        {
        }
    ...
    internal sealed class ValueFunction_UO : BuiltinFunction
    {
        ...
        public ValueFunction_UO()
            : base(ValueFunction.ValueInvariantFunctionName, TexlStrings.AboutValue, FunctionCategories.Text, DType.Number, 0, 0, 1, 1, DType.UntypedObject)
        {
        }
