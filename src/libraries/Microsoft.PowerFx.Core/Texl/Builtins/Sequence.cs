...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class SequenceFunction : BuiltinFunction
    {
        ...
        public SequenceFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "Sequence", TexlStrings.AboutSequence, FunctionCategories.MathAndStat, DType.CreateTable(new TypedName(DType.Number, new DName("Value"))), 0, 1, 3, DType.Number, DType.Number, DType.Number)
        {
        }
