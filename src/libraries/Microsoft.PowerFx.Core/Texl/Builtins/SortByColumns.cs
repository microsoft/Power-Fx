...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class SortByColumnsFunction : BuiltinFunction
    {
        ...
        public SortByColumnsFunction()
            : base("SortByColumns", TexlStrings.AboutSortByColumns, FunctionCategories.Table, DType.EmptyTable, 0, 0, 2, int.MaxValue, DType.EmptyTable, DType.String)
        {
    ...
    internal sealed class SortByColumnsOrderTableFunction : BuiltinFunction
    {
        ...
        public SortByColumnsOrderTableFunction()
            : base("SortByColumns", TexlStrings.AboutSortByColumnsWithOrderValues, FunctionCategories.Table, DType.EmptyTable, 0, 0, 3, 3, DType.EmptyTable, DType.String, DType.EmptyTable)
        {
        }
