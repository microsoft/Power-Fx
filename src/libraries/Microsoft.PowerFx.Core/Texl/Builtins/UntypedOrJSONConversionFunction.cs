...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    internal abstract class UntypedOrJSONConversionFunction : BuiltinFunction
    {
        ...
        // In other words, just because a type is listed here, does not mean it is supported unless it is also supported by an instance of the Engine.
        ...
        // It also excludes Color, as we have not implemented the coversion of "Red" and other color names. We could convert # hex colors but this has not been done yet.
