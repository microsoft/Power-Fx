...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class CountAFunction : FunctionWithTableInput
    {
        ...
        public CountAFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "CountA", TexlStrings.AboutCountA, FunctionCategories.Table | FunctionCategories.MathAndStat, DType.Number, 0, 1, 1, DType.EmptyTable)
        {
        }
