...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class ShowColumnsFunction : FunctionWithTableInput
    {
        ...
        public ShowColumnsFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "ShowColumns", TexlStrings.AboutShowColumns, FunctionCategories.Table, DType.EmptyTable, 0, 2, int.MaxValue, DType.EmptyTable)
        {
        }
        ...
        public override bool CheckTypes(BindingConfig config, TexlNode[] args, DType[] argTypes, IErrorContainer errors, out DType returnType, out Dictionary<TexlNode, DType> nodeToCoercedTypeMap)
        {
            ...
            var isValidInvocation = CheckTypes(args, argTypes, errors, out returnType, out nodeToCoercedTypeMap);
