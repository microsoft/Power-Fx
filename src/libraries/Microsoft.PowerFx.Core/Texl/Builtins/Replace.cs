...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class ReplaceFunction : BuiltinFunction
    {
        ...
        public ReplaceFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "Replace", TexlStrings.AboutReplace, FunctionCategories.Text, DType.String, 0, 4, 4, DType.String, DType.Number, DType.Number, DType.String)
        {
        }
    ...
    internal sealed class ReplaceTFunction : BuiltinFunction
    {
        ...
        public ReplaceTFunction(TexlFunctionConfig instanceConfig)
            : base(instanceConfig, "Replace", TexlStrings.AboutReplaceT, FunctionCategories.Table, DType.EmptyTable, 0, 4, 4)
        {
        }
