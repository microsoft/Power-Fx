...
namespace Microsoft.PowerFx.Core.Texl.Builtins
{
    ...
    internal sealed class IsBlankOrErrorFunction : IsBlankFunctionBase
    {
        ...
        public IsBlankOrErrorFunction()
            : base(IsBlankOrErrorInvariantFunctionName, TexlStrings.AboutIsBlankOrError, FunctionCategories.Table | FunctionCategories.Information, DType.Boolean, 0, 0, 1, 1)
        {
        }
    ...
    internal sealed class IsBlankOrErrorOptionSetValueFunction : BuiltinFunction
    {
        ...
        public IsBlankOrErrorOptionSetValueFunction()
            : base(IsBlankOrErrorFunction.IsBlankOrErrorInvariantFunctionName, TexlStrings.AboutIsBlankOrError, FunctionCategories.Table | FunctionCategories.Information, DType.Boolean, 0, 0, 1, 1, DType.OptionSetValue)
        {
        }
