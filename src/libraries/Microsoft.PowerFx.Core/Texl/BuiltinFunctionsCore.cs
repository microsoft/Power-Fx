...
namespace Microsoft.PowerFx.Core.Texl
{
    ...
    {        
        ...
        // Decimal TODO: Best way to handle limiting exposure of Float and Decimal functions, W overloads, especially for Canvas
        ...
        public static readonly TexlFunction Max = _library.Add(new MaxFunction());
        public static readonly TexlFunction MaxT = _library.Add(new MaxTableFunction());
        ...
        public static readonly TexlFunction Min = _library.Add(new MinFunction());
        public static readonly TexlFunction MinT = _library.Add(new MinTableFunction());
        ...
        public static readonly TexlFunction SequenceW = _library.Add(new SequenceWFunction());
