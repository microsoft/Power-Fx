...
namespace Microsoft.PowerFx.Core.Texl
{
    ...
    internal class BuiltinFunctionsCore
    {
        ...
        public static readonly TexlFunction Collect = _library.Add(new CollectFunction());
        public static readonly TexlFunction CollectS = _library.Add(new CollectScalarFunction());
