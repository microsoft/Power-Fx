...
namespace Microsoft.AppMagic.Transport
{
    ...
    {
        public TransportMethodAttribute(bool supportSynchronousClient = false, TransportBatchingMode batchingMode = TransportBatchingMode.Default, bool isParallel = false, bool xxx = true)
        {
